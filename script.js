...
console.log(Number.parseInt('ee30px', 10));
...
console.log(Math.max(5, 23, 45, 11, 3));
console.log(Math.max(5, 23, '45', 11, 3));
console.log(Math.max(5, 23, '45px', 11, 3));
console.log(Math.min(5, 23, 45, 11, 3));
...
console.log(767889709024894789489289353n);
console.log(BigInt(76788970903));

//operations
console.log(10000n + 10000n);
console.log(726827427847649740921n + 1000000n);
//console.log(Math.sqrt(16n)); //Uncaught TypeError: Cannot convert a BigInt value to a number

const huge = 78942792998492904n;
const num = 23;
//console.log(huge * num); //Uncaught TypeError: Cannot mix BigInt and other types, use explicit conversions
console.log(huge * BigInt(num)); //1815684238965336792n
...
console.log(new Date('Aug 16 2022 19:03:34 '));
...
console.log(+future); //2142237180000ms
...
console.log('INDIA:', new Intl.NumberFormat('te-IN', options).format(num));
